...
import { ACTORS, DIRECTORS, GENRES, KEYWORDS, MOVIES, MOVIE_RATINGS, PRODUCTION_COMPANIES } from "../src/table-names";
...
describe("Simple Queries", () => {
  ...
  it(
    ...
    async done => {
      const query = `SELECT count(*) as count, user_id FROM ${MOVIE_RATINGS} GROUP BY user_id ORDER BY count DESC LIMIT 3`;
      const result = await db.selectMultipleRows(query);
